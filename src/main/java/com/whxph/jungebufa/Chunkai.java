...
public class Chunkai {
    ...
    @SuppressWarnings("unused")
    @NacosValue(value = "${chunkai.pm25}", autoRefreshed = true)
    private Float pm25;

    @SuppressWarnings("unused")
    @NacosValue(value = "${chunkai.pm10}", autoRefreshed = true)
    private Float pm10;

    @SuppressWarnings("unused")
    @NacosValue(value = "${chunkai.noise}", autoRefreshed = true)
    private Float noise;

    @SuppressWarnings("unused")
    @NacosValue(value = "${chunkai.windDirection}", autoRefreshed = true)
    private Float windDirection;

    @SuppressWarnings("unused")
    @NacosValue(value = "${chunkai.windSpeed}", autoRefreshed = true)
    private Float windSpeed;

    @SuppressWarnings("unused")
    @NacosValue(value = "${chunkai.temperature}", autoRefreshed = true)
    private Float temperature;

    @SuppressWarnings("unused")
    @NacosValue(value = "${chunkai.humidity}", autoRefreshed = true)
